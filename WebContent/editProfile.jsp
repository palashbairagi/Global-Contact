...
if(rset.next())
{
	...
	String contactNumber=rset.getString(8);
	...
	%>
<form id="theForm" action="updateProfile.jsp" method="post">
...
<tr><td>Email Id<td><input type="text" class="required" placeholder="Enter Email Id" name="emailId" disabled="disabled" value="<%=emailId %>"/>
...
<%}else { %>
<td colspan='2' align="center"> <input type="radio" name="gender" value="M" />Male
...
<select name="month">
<%if(month=="Jan")%><option value="Jan" selected="selected">Jan</option><%else %><option value="Jan">Jan</option>
