...
PreparedStatement stmt=con.prepareStatement("select receiver_Email_Id,message,date_of_message from draft_info where sender_Email_Id=? order by date_of_message desc");
stmt.setString(1,emailId);
ResultSet rset=stmt.executeQuery();
while(rset.next())
{%>
<tr>
<form action="afterDraftPage.jsp">
<td><%=rset.getString(1)%><input type="hidden" name="receiverEmailId" value="<%=rset.getString(1)%>"></td>
